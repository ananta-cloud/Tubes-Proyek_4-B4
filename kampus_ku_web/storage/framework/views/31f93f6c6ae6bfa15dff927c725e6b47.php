                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-6 py-4">
                        ...
                        <span class="bg-indigo-50 text-indigo-600 text-[10px] font-bold px-2 py-0.5 rounded border border-indigo-100 mt-1 inline-block">
                            <?php echo e(is_array($ann->kategori) ? implode(', ', $ann->kategori) : ($ann->kategori ?? 'Umum')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Semester 4\Proyek 4\Tubes-Proyek_4-B4\kampus_ku_web\resources\views/admin/announcements/index.blade.php ENDPATH**/ ?>